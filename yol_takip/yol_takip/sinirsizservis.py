...
def generateGraph():
 ...
 return yenivertice, edges, capacityLimit, demand, feromones
...
def main():
    bestSolution = None
    vertices, edges, capacityLimit, demand, feromones = generateGraph()
...
if __name__ == "__main__":
    ...
    ref = db.collection(u'rotalar').document(u'1')
    ref2 = db.collection(u'maliyetler').document(u'1')
    ref2.update({u'maliyet': str(solution[1])})
    ref.update({u'rota': str(liste)})
    ref3 = db.collection(u'rotadizi').document(u'1')
