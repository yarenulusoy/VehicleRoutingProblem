...
public class rota2 extends AppCompatActivity implements OnMapReadyCallback, Window.Callback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DocumentReference docRef = db.collection("rotalar").document("2");
        ...
        tablo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent giris = new Intent(rota2.this,Tablolar.class);
                startActivity(giris);
            }
        });
                ...
                for (int i = 0; i < rotalar.size()-2; i += 2) {
                    if(i!=0){
                        if(rotalar.get(i)==40.823371 || rotalar.get(i+2)==40.823371) {
                            ...
                            i=i+2;
                            new FetchURL(rota2.this).execute(getUrl(new MarkerOptions().position(new LatLng(rotalar.get(i), rotalar.get(i+1))).
